...
class RecycleCommonAdapter(mContext:Context, private var mData:ArrayList<String>) : RecyclerView.Adapter<CommonViewHolder>(){
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): CommonViewHolder {
       val view = mInflater?.inflate(R.layout.recycle_view_test_item,p0,false)
